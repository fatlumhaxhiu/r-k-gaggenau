...
<main>
{/*  Hero Section  */}
<section className="relative min-h-svh flex items-center overflow-hidden bg-surface-container-low">
...
<h1 className="font-headline text-3xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter text-on-surface leading-none mb-8" >
...
<h2 className="font-headline text-3xl md:text-5xl font-bold mt-2" >Was enthalten ist</h2>
</div>
<div className="flex flex-col md:grid md:grid-cols-12 gap-8 h-auto w-full">
{/*  Major Card  */}
<div className="w-full md:col-span-8 group bg-surface-container-low rounded-3xl p-6 sm:p-10 flex flex-col justify-between relative overflow-hidden transition-all hover:bg-surface-container-lowest border border-transparent hover:border-outline-variant/30 min-w-0">
<div className="relative z-10 flex flex-col items-center sm:items-start text-center sm:text-left">
<span className="text-6xl font-headline font-black text-primary/10 absolute -top-4 left-1/2 -translate-x-1/2 sm:-left-2 sm:translate-x-0" >01</span>
<h3 className="text-2xl font-headline font-bold mb-4 mt-12 sm:mt-8 wrap-break-word hyphens-auto max-w-full" lang="de" >Baufein&shy;reinigung</h3>
...
<div className="mt-12 flex flex-col sm:flex-row items-center sm:items-center justify-center sm:justify-start gap-4 sm:gap-6 text-center sm:text-left">
...
<div className="hidden sm:block h-10 w-px bg-outline-variant"></div>
<div className="flex flex-col items-center sm:items-start">
<span className="font-bold text-primary" >HEPA-Luft&shy;reinigung</span>
...
{/*  Side Card 1  */}
<div className="w-full md:col-span-4 bg-secondary text-on-secondary rounded-3xl p-6 sm:p-10 flex flex-col justify-center items-center sm:items-start text-center sm:text-left hover:scale-[1.02] transition-transform min-w-0">
<span className="text-5xl font-headline font-black opacity-30 mb-4" >02</span>
<h3 className="text-2xl font-headline font-bold mb-4 wrap-break-word hyphens-auto" lang="de" >Baugrob&shy;reinigung</h3>
...
{/*  Bottom Card  */}
<div className="w-full md:col-span-12 bg-surface-container-highest rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-12 group min-w-0">
<div className="md:w-1/2 flex flex-col items-center sm:items-start text-center sm:text-left">
<span className="text-5xl font-headline font-black text-primary/20 mb-4 block" >03</span>
<h3 className="text-2xl font-headline font-bold mb-4 wrap-break-word hyphens-auto" lang="de" >Schutt&shy;entsorgung</h3>
...
<ul className="mt-8 space-y-3 flex flex-col items-center sm:items-start">
...
<h2 className="font-headline text-3xl md:text-6xl font-extrabold tracking-tight" >Auf Exzellenz programmiert</h2>
...
<h3 className="font-headline text-2xl font-bold mb-4" >Vertraut von führenden Entwicklern</h3>
...
<div className="md:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-4 items-center justify-items-center opacity-40 grayscale hover:grayscale-0 transition-all w-full min-w-0">
<div className="font-black text-lg sm:text-xl md:text-2xl text-center leading-none tracking-tight" >ARCHITECTS<br className="sm:hidden" /><span className="sm:inline hidden"> </span>INC</div>
<div className="font-black text-lg sm:text-xl md:text-2xl text-center leading-none tracking-tight" >BUILD-CO</div>
<div className="font-black text-lg sm:text-xl md:text-2xl text-center leading-none tracking-tight" >SKYLINE</div>
<div className="font-black text-lg sm:text-xl md:text-2xl text-center leading-none tracking-tight" >URBAN<br className="sm:hidden" /><span className="sm:inline hidden"> </span>GRID</div>
</div>
</div>
</div>
</section>
...
<div className="max-w-7xl mx-auto px-8 flex flex-col lg:grid lg:grid-cols-2 gap-16 items-center w-full">
<div className="order-2 lg:order-1">
<div className="bg-surface-container-lowest p-6 sm:p-10 rounded-[2rem] shadow-2xl shadow-primary/5">
...
<h2 className="font-headline text-3xl md:text-5xl font-extrabold mt-4 mb-8" >Machen wir Ihr Objekt bereit für die Übergabe.</h2>
...
<h2 className="font-headline text-3xl md:text-6xl font-bold mb-8" >Bereit für die Eröffnung?</h2>
<p className="text-lg md:text-xl opacity-80 mb-12 max-w-2xl mx-auto" >Lassen Sie Baustaub nicht den Glanz Ihres Entwurfs trüben. Sichern Sie sich heute eine Präzisionsreinigung.</p>
<a className="inline-flex w-full sm:w-auto bg-primary-fixed text-on-primary-fixed px-8 sm:px-12 py-5 rounded-full font-black text-xl hover:scale-105 transition-transform" href="#contact" >
                Kostenloses Angebot
            </a>
</div>
</section>
